...
public class MenuController {
    @FXML private VBox menuTextos; //no se usa pero cambia los tamaños del layout
    ...
    @FXML private ImageView iconTotal; //no se usa pero cambia los tamaños del layout
